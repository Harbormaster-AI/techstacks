...
// *********
@StartableByRPC
class Create${className}Token(private val ${lowercaseClassName}Serial: String) : FlowLogic<String>() {
    ...
    override fun call():String {
        ...
        val ${lowercaseClassName} = ${className}TokenState(ourIdentity, uuid,0,${lowercaseClassName}Serial)
        ...
        return "\nCreated a ${lowercaseClassName} token for ${tokenSystemName} ${lowercaseClassName}. (Serial #" + this.${lowercaseClassName}Serial + ")."
    }
}
